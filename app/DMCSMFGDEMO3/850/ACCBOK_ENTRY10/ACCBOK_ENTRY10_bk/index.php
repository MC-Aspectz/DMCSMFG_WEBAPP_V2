...
<div class="flex flex-col h-screen">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex flex-1 overflow-y-auto overflow-x-hidden paragraph px-2">
                    ...
                    <details class="p-1.5 w-full align-middle" open><!-- open -->
                        ...
                        <div class="flex mb-1">
                            <div class="flex w-6/12">
                                ...
                                <input type="text" class="text-control shadow-md border z-20 rounded-xl h-7 w-6/12  ml-2 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500 read"
                                    name="INP_STFNM" id="INP_STFNM" value="<?=isset($data['INP_STFNM']) ? $data['INP_STFNM']: ''; ?>"readonly/>
                            </div>

                            <div class="flex w-6/12">
                                <label class="text-color block text-sm w-3/12 pt-1 ml-2"><?=checklang('DIVISIONCODE')?></label>
                                <div class="relative w-3/12">
                                    <input type="text" class="text-control shadow-md border z-20 rounded-xl h-7 w-full py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                                ...
                                <input type="text" class="text-control shadow-md border z-20 rounded-xl h-7 ml-1 w-6/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500 read"
                        ...
                        <div class="flex mb-1">
                            <div class="flex w-6/12">
                                ...
                                <input type="text" class="text-control shadow-md border z-20 rounded-xl h-7 w-3/12 ml-1 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500 read"
                                    name="SUPPLIERNAME" id="SUPPLIERNAME" value="<?=isset($data['SUPPLIERNAME']) ? $data['SUPPLIERNAME']: ''; ?>" readonly/> 
                            </div>
                            <div class="flex w-6/12">
                                <label class="invisible text-color block text-sm w-3/12 pr-2 pt-1 ml-2"></label>
                                <select class="text-control shadow-md border mr-2 px-3 h-7 w-3/12 text-left text-[12px] rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500" 
                        ...
                        <div class="flex mb-1">
                            <div class="flex w-6/12">
                                ...
                                <label class="text-color block text-sm w-1/12 pr-2 pt-1 ml-1"><?=checklang('QTY')?></label>
                            ...
                            <div class="flex w-6/12">
                                <label class="text-color block text-sm w-3/12 pr-2 pt-1 ml-2"><?=checklang('UNIT_PRICE')?></label>
                                <input type="text" class="text-control shadow-md border z-20 rounded-xl h-7 w-2/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                                    ...
                                    oninput="this.value = this.value.replace(/[^0-9.,]/g, '').replace(/(\..*?)\..*/g, '$1');"/>
                                <select class="text-control shadow-md border mr-2 px-3 h-7 w-20 ml-1 text-left text-[12px] rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500" 
                                ...
                                <input class="ml-1" type="checkbox" id="DEPREC_A" name="DEPREC_A" value="T" onclick="chkDEPREC();" <?php echo (isset($data['DEPREC_A']) && $data['DEPREC_A'] == 'T') ? 'checked' : '' ?>/>
                                <label class="text-color block text-sm pt-1 -ml-1 w-3/12 text-center"><?=checklang('DEPREC_AUTO')?></label>
                            </div>
                        </div>
                        ...
                        <div class="flex mb-1">
                            ...
                            <div class="flex w-6/12">
                                ...
                                <input type="text" class="text-control shadow-md border z-20 rounded-xl ml-1 h-7 w-3/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500 read"
                        ...
                        <div class="flex mb-1">
                            ...
                            <div class="flex w-6/12">
                                <label class="text-color block text-sm w-3/12 ml-2 pt-1"><?=checklang('SERIALNO')?></label>
                                <input type="text" class="text-control shadow-md border z-20 rounded-xl h-7 -ml-2 w-4/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div class="flex mb-1">
                            <div class="flex w-6/12">
                                ...
                                <input class="text-control shadow-md border z-20 rounded-xl h-7 w-3/12 py-2 px-3 ml-6 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500 text-center"
                                ...
                                <input type="text" class="text-control shadow-md border z-20 rounded-xl h-7 w-2/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                                    ...
                                    oninput="this.value = this.value.replace(/[^0-9.,]/g, '').replace(/(\..*?)\..*/g, '$1');"/>
                                <label class="text-color block text-sm w-1/12 pr-2 ml-1 pt-1"><?=checklang('YEAR')?></label>
                            </div>
                            <div class="flex w-6/12">
                                <label class="text-color block text-sm w-3/12 pr-2 ml-2 pt-1"><?=checklang('RATE')?></label>
                                <input type="text" class="text-control shadow-md border z-20 rounded-xl -ml-1 h-7 w-2/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500 read"
            ...
            <!-- Table -->
            <div class="overflow-scroll px-2 block h-[192px] max-h-[192px] mt-2"> 
                ...
                if(!empty($data['ITEM']))  {
                    ...
                    foreach ($data['ITEM'] as $key => $value) { ?>
                        <tr class="divide-y divide-gray-200 csv" id="rowId<?=$key?>">
                            <td class="h-6 text-sm border border-slate-700 text-center row-id" id="ROWNO_TD<?=$key?>"><?=isset($value['ROWNO']) ? $value['ROWNO']: '' ?></td>
                            <td class="h-6 pl-2 text-sm border border-slate-700 text-left whitespace-nowrap" id="ACC_CD_TD<?=$key?>"><?=isset($value['ACC_CD']) ? $value['ACC_CD']: '' ?></td>
                            <td class="h-6 pl-2 text-sm border border-slate-700 text-left whitespace-nowrap" id="ACC_NM_TD<?=$key?>"><?=isset($value['ACC_NM']) ? $value['ACC_NM']: '' ?></td>
                            <td class="h-6 pl-2 text-sm border border-slate-700 text-left whitespace-nowrap" id="ACCTRANREMARK_TD<?=$key?>"><?=isset($value['ACCTRANREMARK']) ? $value['ACCTRANREMARK']: '' ?></td>
                            <td class="h-6 pl-2 text-sm border border-slate-700 text-left whitespace-nowrap" id="ACCAMT1_TD<?=$key?>"><?=isset($value['ACCAMT1']) ? $value['ACCAMT1']: '' ?></td>
                            <td class="h-6 pl-2 text-sm border border-slate-700 text-left whitespace-nowrap" id="ACCAMT2_TD<?=$key?>"><?=isset($value['ACCAMT2']) ? $value['ACCAMT2']: '' ?></td>
                            <td class="h-6 pl-2 text-sm border border-slate-700 text-left whitespace-nowrap" id="SECTION1_TD<?=$key?>"><?=isset($value['SECTION1']) ? $value['SECTION1']: '' ?></td>
                            <td class="h-6 pl-2 text-sm border border-slate-700 text-left whitespace-nowrap"></td>

                            <td class="hidden" id="PROJECTNO_TD<?=$key?>"><?=isset($value['PROJECTNO']) ? $value['PROJECTNO']: '' ?></td>
                            <td class="hidden" id="DC_TYPE_TD<?=$key?>"><?=isset($value['DC_TYPE']) ? $value['DC_TYPE']: '' ?></td>
                            <td class="hidden" id="EXRATE_TD<?=$key?>"><?=isset($value['EXRATE']) ? $value['EXRATE']: '' ?></td>
                            <td class="hidden" id="CURRENCY1_TD<?=$key?>"><?=isset($value['CURRENCY1']) ? $value['CURRENCY1']: '' ?></td>
                            <td class="hidden" id="I_CURRENCY_TD<?=$key?>"><?=isset($value['I_CURRENCY']) ? $value['I_CURRENCY']: '' ?></td>
                            <td class="hidden" id="VOUCHERNO_TD<?=$key?>"><?=isset($value['VOUCHERNO']) ? $value['VOUCHERNO']: '' ?></td>

                            <td class="hidden"><input type="hidden" id="ROWNO<?=$key?>" name="ROWNOA[]" value="<?=isset($value['ROWNO']) ? $value['ROWNO']: '' ?>"></td>
                            <td class="hidden"><input type="hidden" id="VOUCHERNO<?=$key?>" name="VOUCHERNOA[]" value="<?=isset($value['VOUCHERNO']) ? $value['VOUCHERNO']: '' ?>"></td>
            ...
            <div class="flex mb-1">
                ...
                <div class="flex w-6/12">
                        ...
                        <input type="text" class="text-control shadow-md border z-20 rounded-xl h-7 w-2/12 ml-1 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500 read"
            ...
            <div class="flex mb-1">
                ...
                <div class="flex w-6/12">
                    <label class="text-color block text-sm w-2/12 pr-2 pt-1 ml-2"><?=checklang('DEBIT')?></label>
                    <label class="text-color block text-sm w-2/12 pr-2 pt-1 ml-2"><?=checklang('CREDIT')?></label>
                </div>
            </div>
            ...
            <div class="flex mb-1">
                <div class="flex w-6/12">
                    ...
                    <input type="text" class="text-control shadow-md border z-20 rounded-xl ml-1 h-7 w-6/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500 read"
                        name="ACC_NM" id="ACC_NM" value="<?=isset($data['ACC_NM']) ? $data['ACC_NM']: ''; ?>" readonly/>
                </div>
                <div class="flex w-6/12">
                    <input type="text" class="text-control shadow-md border z-20 rounded-xl h-7 ml-1 w-2/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500 read"
                    ...
                    <select class="text-control shadow-md border mr-2 px-3 h-7 w-1/12 ml-1 text-left text-[12px] rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500" 
            ...
            <div class="flex mb-1">
                <div class="flex w-6/12">
                    ...
                    <label class="text-color block text-sm w-1/12 ml-1 pr-2 pt-1"><?=checklang('AMOUNT')?></label>
                    <input type="text" class="text-control shadow-md border z-20 rounded-xl h-7 w-2/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div class="flex w-6/12">
                    <label class="text-color block text-sm w-2/12 ml-2 pr-2 pt-1"><?=checklang('PROJECTNO')?></label>
                    <input type="text" class="text-control shadow-md border z-20 rounded-xl h-7 w-3/12 py-2 px-3 text-gray-700 border-gray-300 focus:ring-blue-500 focus:border-blue-500"
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#INSERT').click(function() {
            ...
            cols += '<td class="h-6 w-3/12 text-sm text-center border border-slate-700"  id="ACC_NM_TD'+index+'">'+ $('#ACC_NM').val() +'</td>';
            ...
            cols += '<td class="hidden"><input type="hidden" id="VOUCHERNO'+index+'" name="VOUCHERNOA[]" value='+ $('#VOUCHERNO').val() +'></td>';
            ...
            cols += '<td class="hidden"><input type="hidden" id="DC_TYPE'+index+'" name="DC_TYPEA[]" value='+ $('#DC_TYPE').val() +'></td>';
            cols += '<td class="hidden"><input type="hidden" id="CURRENCY1'+index+'" name="CURRENCY1A[]" value='+ document.getElementById("CURRENCY1x").value +'></td>';
            cols += '<td class="hidden"><input type="hidden" id="I_CURRENCY'+index+'" name="I_CURRENCYA[]" value='+ document.getElementById("I_CURRENCYx").value +'></td>';
            cols += '<td class="hidden"><input type="hidden" id="EXRATE'+index+'" name="EXRATEA[]" value='+ $('#EXRATEx').val() +'></td>';
            cols += '<td class="hidden"><input type="hidden" id="AMT'+index+'" name="AMTA[]" value='+ $('#AMT').val() +'></td></tr>';
    ...
    if (urlParams.has('showDialog') && urlParams.get('showDialog') == '1') {
        actionDialog(4);
    }
}
</script>
