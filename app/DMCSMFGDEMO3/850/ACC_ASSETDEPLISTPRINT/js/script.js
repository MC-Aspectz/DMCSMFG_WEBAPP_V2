...
assetaccguide.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/ASSETACCGUIDE/index.php?page=ACC_ASSETDEPLISTPRINT&index=1', 'authWindow', 'width=1200,height=600');});
// assetaccguide2.attr('href', $('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/ASSETACCGUIDE/index.php?index=2');
assetaccguide2.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/ASSETACCGUIDE/index.php?page=ACC_ASSETDEPLISTPRINT&index=2', 'authWindow', 'width=1200,height=600');});
...
async function Prints() {
    ...
    await axios.post('../ACC_ASSETDEPLISTPRINT/function/index_x.php', data)
    .then(response => {
...
async function printed() {
   ...
   // var popupWindow = window.open('https://web-develop.dmcs.biz/DMCS_WEBAPP/home.php', '_blank', 'width=800, height=800');
     var popupWindow = window.open('../ACC_ASSETDEPLISTPRINT/print.php', '_blank', 'width=800, height=800');
...
function HandlePopupResultIndex(code, result, index) {
    ...
    $("#loading").show();
    return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/850/ACC_ASSETDEPLISTPRINT/index.php?'+code+'=' + result + '&index=' + index;
}

function HandlePopupResult(code, result) {
    // console.log("result of popup is: " + code + ' : ' + result);
    $("#loading").show();
    return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/850/ACC_ASSETDEPLISTPRINT/index.php?'+code+'=' + result;
}
