...
SEARCHACCOUNT1.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCOUNT/index.php?page=ASSETACCMASTER&index=1', 'authWindow', 'width=1200,height=600');});
// SEARCHACCOUNT2.attr('href', $('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCOUNT/index.php?index=2');
SEARCHACCOUNT2.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCOUNT/index.php?page=ASSETACCMASTER&index=2', 'authWindow', 'width=1200,height=600');});
// SEARCHACCOUNT3.attr('href', $('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCOUNT/index.php?index=3');
SEARCHACCOUNT3.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCOUNT/index.php?page=ASSETACCMASTER&index=3', 'authWindow', 'width=1200,height=600');});
...
function HandlePopupResultIndex(code, result, index) {
    ...
    $("#loading").show();
    return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/850/ASSETACCMASTER/index.php?'+code+'=' + result + '&index=' + index;
}

function HandlePopupResult(code, result) {
    // console.log("result of popup is: " + code + ' : ' + result);
    $("#loading").show();
    return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/850/ASSETACCMASTER/index.php?'+code+'=' + result;
}
...
async function commit(method) {
    ...
    await axios.post('../ASSETACCMASTER/function/index_x.php', data)
    .then(response => {
