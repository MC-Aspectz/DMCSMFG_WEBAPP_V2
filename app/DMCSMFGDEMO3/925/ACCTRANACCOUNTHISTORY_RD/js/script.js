...
//searchstaff.attr('href', $('#sessionUrl').val() + '/guide/SEARCHSTAFF/index.php');
//input serach
...
// form
const form = document.getElementById("loginhistoryaccountrd");
...
async function keepData() {
  ...
  await axios
    .post("../ACCTRANACCOUNTHISTORY_RD/function/index_x.php", data)
    .then((response) => {
...
async function clearForm(form) {
  ...
  // refresh
  if (form.id == "loginhistoryaccountrd") {
    // window.location.href = "index.php";
    window.location.href = "../ACCTRANACCOUNTHISTORY_RD/";
  }
  return false;
}
