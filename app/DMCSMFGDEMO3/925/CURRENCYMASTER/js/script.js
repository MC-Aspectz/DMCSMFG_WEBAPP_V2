...
// form
const form = document.getElementById("currency_master");
...
async function commit(method) {
  ...
  await axios
    .post("../CURRENCYMASTER/function/index_x.php", data)
    .then((response) => {
      // console.log(response.data)
...
function unRequired() {
  let CURRENCYCD = document.getElementById("CURRENCYCD");

  CURRENCYCD.classList[CURRENCYCD.value !== "" ? "remove" : "add"]("req");
}
...
async function clearForm(form) {
  ...
  // refresh
  window.location.href = "../CURRENCYMASTER/";
