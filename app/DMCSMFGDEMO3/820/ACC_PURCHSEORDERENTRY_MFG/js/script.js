...
SEARCHPURCHASEREQUEST.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHPURCHASEREQUEST/index.php?page=ACC_PURCHSEORDERENTRY_MFG', 'authWindow', 'width=1200,height=600');});
SEARCHPURCHASEORDER.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHPURCHASEORDER/index.php?page=ACC_PURCHSEORDERENTRY_MFG', 'authWindow', 'width=1200,height=600');});
SEARCHDIVISION.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHDIVISION/index.php?page=ACC_PURCHSEORDERENTRY_MFG', 'authWindow', 'width=1200,height=600');});
SEARCHSUPPLIER.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHSUPPLIER/index.php?page=ACC_PURCHSEORDERENTRY_MFG', 'authWindow', 'width=1200,height=600');});
SEARCHSTAFF.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHSTAFF/index.php?page=ACC_PURCHSEORDERENTRY_MFG', 'authWindow', 'width=1200,height=600');});
SEARCHCURRENCY.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHCURRENCY/index.php?page=ACC_PURCHSEORDERENTRY_MFG', 'authWindow', 'width=1200,height=600');});
...
// form
const form = document.getElementById('purchseOrderEntryMFG');
...
async function getSearch(code, value) {
    $('#loading').show();
    return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/820/ACC_PURCHSEORDERENTRY_MFG/index.php?'+code+'=' + value;
}
...
async function back(PONO = '') {
    ...
    .then((response) => {
      if(response.status == 200) {
          // console.log(response.data);
        if(PROORDERNO != '') {
            return $.redirect($('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/400/ORDERBMENTRY/index.php', { PONO: PONO });
        } else {
...
async function unsetSessionItem(lineIndex) {
    ...
    .then((response) => {
        // console.log(response.data)
        return window.location.href = '../ACC_PURCHSEORDERENTRY_MFG/index.php?ITEMCD=';
...
async function clearForm(form) {
    ...
    // refresh
    window.location.href = '../ACC_PURCHSEORDERENTRY_MFG/';
...
function searchItemIndex(lineIndex) {
    ...
    return window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHITEM/index.php?page=ACC_PURCHSEORDERENTRY_MFG&index=' + lineIndex, 'authWindow', 'width=1200,height=600');
}
