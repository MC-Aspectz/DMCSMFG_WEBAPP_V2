...
function commit() {
    $RowParam = array();
    $cmtfunc = new AccPurchseOrderEntryMFG;
    // PONO,ISSUEDT,PRNO,DIVISIONCD,SUPPLIERCD,SUPCURCD,SUPPLIERCONTACT,SUPPLIERTEL,SUPPLIERFAX,STAFFCD,ADD03,ADD04,ADD05,ADD06,ADD07,ADD08,PURDUEDT,DISCRATE,VATRATE,VATAMOUNT1,DVW,PCALLOCORDERTYP,PCALLOCORDERNO
...
function printed() {
    ...
    try {
        $printfunc = new AccPurchseOrderEntryMFG;
