...
<div class="flex flex-col h-screen">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex flex-1 overflow-y-auto paragraph">
            ...
            <form class="w-full" method="POST" id="purchseOrderEntryMFG" name="purchseOrderEntryMFG" action="" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        document.getElementById('COMMIT').classList[SYSVIS_INS == 'F' ? 'add' : 'remove']('hidden');
        document.getElementById('CANCEL').classList[SYSVIS_DEL == 'F' ? 'add' : 'remove']('hidden');
