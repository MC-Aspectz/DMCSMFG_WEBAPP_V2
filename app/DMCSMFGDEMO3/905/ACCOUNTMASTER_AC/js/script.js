...
async function getSearch(code, value) {
    $('#loading').show();
    return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/905/ACCOUNTMASTER_AC/index.php?'+code+'=' + value;  
}
...
async function commit(method) {
    ...
    await axios.post('../ACCOUNTMASTER_AC/function/index_x.php', data)
    .then(response => {
