...
SEARCHCUSTOMER.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHCUSTOMER/index.php?page=ACC_WHTMETHOD3', 'authWindow', 'width=1200,height=600');});
SEARCHACCOUNT1.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCOUNT/index.php?page=ACC_WHTMETHOD3&index=1', 'authWindow', 'width=1200,height=600');});
SEARCHACCOUNT2.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCOUNT/index.php?page=ACC_WHTMETHOD3&index=2', 'authWindow', 'width=1200,height=600');});
SEARCHACCOUNT3.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCOUNT/index.php?page=ACC_WHTMETHOD3&index=3', 'authWindow', 'width=1200,height=600');});

const serach_icon = [ SEARCHCUSTOMER, SEARCHACCOUNT1, SEARCHACCOUNT2, SEARCHACCOUNT3];
...
async function getSearch(code, value) {
    $('#loading').show();
    return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/905/ACC_WHTMETHOD3/index.php?'+code+'=' + value;  
}
...
async function commit(method) {
    ...
    await axios.post('../ACC_WHTMETHOD3/function/index_x.php', data)
    .then(response => {
