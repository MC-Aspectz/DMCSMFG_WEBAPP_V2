...
SEARCHACCIFCD.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCIFCD/index.php?page=ACCIFSETUP', 'authWindow', 'width=1200,height=600');});
SEARCHACCOUNT1.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCOUNT/index.php?page=ACCIFSETUP&index=1', 'authWindow', 'width=1200,height=600');});
SEARCHACCOUNT2.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCOUNT/index.php?page=ACCIFSETUP&index=2', 'authWindow', 'width=1200,height=600');});
SEARCHACCOUNT3.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCOUNT/index.php?page=ACCIFSETUP&index=3', 'authWindow', 'width=1200,height=600');});
SEARCHACCOUNT4.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCOUNT/index.php?page=ACCIFSETUP&index=4', 'authWindow', 'width=1200,height=600');});

const serach_icon = [ SEARCHACCIFCD, SEARCHACCOUNT1, SEARCHACCOUNT1, SEARCHACCOUNT2, SEARCHACCOUNT3, SEARCHACCOUNT4];
...
const input_serach = [ITEMTYP, DEBITACCCD1, DEBITACCCD2, CREDITACCCD1, CREDITACCCD2];
...
async function getSearch(code, value) {
    $('#loading').show();
    return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/905/ACCIFSETUP/index.php?'+code+'=' + value;  
}
...
async function SetAccEnable() {
    ...
    await axios.post('../ACCIFSETUP/function/index_x.php', data)
    .then(response => {
       // window.alert('555');
...
function emptyRow() {
    for (var i = 0; i < 10; i++) {
        $('#dvwdetail').append('<tr class="border border-gray-600">' +
