...
SEARCHACCIFCD.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCIFCD/index.php?page=ACCIFCDMASTER', 'authWindow', 'width=1200,height=600');});
SEARCHACCIFCD1.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHACCIFCD/index.php?page=ACCIFCDMASTER1', 'authWindow', 'width=1200,height=600');});
...
async function getSearch(code, value) {
    $('#loading').show();
    return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/905/ACCIFCDMASTER/index.php?'+code+'=' + value;  
}
...
async function commit(method) {
    ...
    await axios.post('../ACCIFCDMASTER/function/index_x.php', data)
    .then(response => {
