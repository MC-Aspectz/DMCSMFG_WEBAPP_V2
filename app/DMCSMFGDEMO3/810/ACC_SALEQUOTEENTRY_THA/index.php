...
<div class="flex flex-col h-screen">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex flex-1 overflow-y-auto paragraph">
            ...
            <form class="w-full mx-2" method="POST" id="quoteentry" name="quoteentry" action="" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false; }">
...
<script type="text/javascript">
    ...
    function searchItemIndex(lineIndex) {
        ...
        if($('#CUSTOMERCD').val() == '' || $('#CUSTOMERCD').val() == 'undefined') {
           ...
           keepData();
           return window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHITEM/index.php?page=ACC_SALEQUOTEENTRY_THA&index=' + lineIndex, 'authWindow', 'width=1200,height=600');
        }
    }
    ...
    function HandlePopupItem(result, index) {
        ...
        // return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/810/ACC_SALEQUOTEENTRY_THA/index.php?ITEMCD=' + result +'&index=' + index;
    }
