...
SEARCHQUOTE.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHQUOTE/index.php?page=ACC_SALEQUOTEENTRY_THA', 'authWindow', 'width=1200,height=600');});

CLONEQUOTE.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHQUOTE/index.php?page=ACC_SALEQUOTEENTRY_THA_CLONE', 'authWindow', 'width=1200,height=600');});

SEARCHDIVISION.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHDIVISION/index.php?page=ACC_SALEQUOTEENTRY_THA', 'authWindow', 'width=1200,height=600');});

SEARCHCUSTOMER.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHCUSTOMER/index.php?page=ACC_SALEQUOTEENTRY_THA', 'authWindow', 'width=1200,height=600');});

SEARCHCURRENCY.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHCURRENCY/index.php?page=ACC_SALEQUOTEENTRY_THA', 'authWindow', 'width=1200,height=600');});

SEARCHSTAFF.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHSTAFF/index.php?page=ACC_SALEQUOTEENTRY_THA', 'authWindow', 'width=1200,height=600');});
...
// form
const form = document.getElementById('quoteentry');
...
async function getSearch(code, value) {
    $('#loading').show();
    if(code == 'ESTNOCLONE') {
        return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/810/ACC_SALEQUOTEENTRY_THA/index.php?ESTNOCLONE=' + value;
    } else {
        return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/810/ACC_SALEQUOTEENTRY_THA/index.php?'+code+'=' + value;
    }
}
...
async function getElement(code, value) {
    ...
    await axios.post('../ACC_SALEQUOTEENTRY_THA/function/index_x.php', data)
    .then(response => {
...
async function unsetSessionItem(lineIndex) {
    ...
    .then((response) => {
      // console.log(response.data);
      return window.location.href = '../ACC_SALEQUOTEENTRY_THA/index.php';
...
async function clearForm(form) {
  // clearing inputs
    ...
    // refresh
    if (form.id == 'quoteentry') {
        window.location.href = '../ACC_SALEQUOTEENTRY_THA/';
    }
    return false;
}
...
//   var popupWindow = window.open('../ACC_SALEQUOTEENTRY_THA/print.php', '_blank', 'width=800, height=800');
//   setTimeout(function () {
//     popupWindow.close();
//   }, 10000);
