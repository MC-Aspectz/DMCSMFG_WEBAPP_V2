...
<div class="flex flex-col h-screen">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex flex-1 overflow-y-auto paragraph">
            ...
            <form class="w-full" method="POST" id="productionOrderEntryMFG" name="productionOrderEntryMFG" action="" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
                ...
                <input type="hidden" id="PCALLOCORDERNO" name="PCALLOCORDERNO" value="<?=isset($data['PCALLOCORDERNO']) ? $data['PCALLOCORDERNO']: ''; ?>">
