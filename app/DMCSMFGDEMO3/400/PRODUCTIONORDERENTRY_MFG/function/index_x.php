...
$javaFunc = new ProductionOrderEntryMFG;
...
function update() {
    $updfunc = new ProductionOrderEntryMFG;
    $PROORDERNO = isset($_POST['PROORDERNO']) ? $_POST['PROORDERNO']: '';
    $ITEMCD = isset($_POST['ITEMCD']) ? $_POST['ITEMCD']: '';
    $BMVERSION = !empty($_POST['BMVERSION']) ? $_POST['BMVERSION']: '0';
    $param = array( 'PROORDERNO' => isset($_POST['PROORDERNO']) ? $_POST['PROORDERNO']: '',
...
function delete() {
    $delfunc = new ProductionOrderEntryMFG;
...
function setOrderBOMEntry() {
    $javafunc = new ProductionOrderEntryMFG;
    // print_r($_POST);
    $param = array( 'PFAPPCD' => isset($_POST['PFAPPCD']) ? $_POST['PFAPPCD']: 'ORDERBMENTRY_MFG',
                    'ROWNO' => isset($_POST['ROWNO']) ? $_POST['ROWNO']: '',
                    'ITEMCD' => isset($_POST['ITEMCD']) ? $_POST['ITEMCD']: '',
                    'ODRQTY' => isset($_POST['ODRQTY']) ? $_POST['ODRQTY']: '',
                    'ALLOCQTY' => isset($_POST['ALLOCQTY']) ? $_POST['ALLOCQTY']: '',
                    'ALLOCORDERNO' => isset($_POST['ALLOCORDERNO']) ? $_POST['ALLOCORDERNO']: '',
