...
SEARCHPRODUCTIONORDER.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHPRODUCTIONORDER/index.php?page=PRODUCTIONORDERENTRY_MFG', 'authWindow', 'width=1200,height=600');});
SEARCHITEM.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHITEM/index.php?page=PRODUCTIONORDERENTRY_MFG', 'authWindow', 'width=1200,height=600');});
SEARCHWORKCENTER.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHWORKCENTER/index.php?page=PRODUCTIONORDERENTRY_MFG', 'authWindow', 'width=1200,height=600');});
SEARCHSTAFF.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHSTAFF/index.php?page=PRODUCTIONORDERENTRY_MFG', 'authWindow', 'width=1200,height=600');});
SEARCHSALEORDERDETAIL.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHSALEORDERDETAIL/index.php?page=PRODUCTIONORDERENTRY_MFG', 'authWindow', 'width=1200,height=600');});
PROCESSPATTERNGUIDE.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/PROCESSPATTERNGUIDE/index.php?page=PRODUCTIONORDERENTRY_MFG', 'authWindow', 'width=1200,height=600');});
SEARCHLOC.click(function(e) { e.preventDefault(); winopened = window.open($('#sessionUrl').val() + '/guide/'+ $('#comcd').val() +'/SEARCHLOC/index.php?page=PRODUCTIONORDERENTRY_MFG&LOCTYP=' + $('#LOCTYP').val(), 'authWindow', 'width=1200,height=600');});
...
// form
const form = document.getElementById('productionOrderEntryMFG');
...
async function getSearch(code, value) {
    $('#loading').show();
    return window.location.href = $('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/400/PRODUCTIONORDERENTRY_MFG/index.php?'+code+'=' + value;        
}
...
async function inserted() {
    ...
    await axios.post('../PRODUCTIONORDERENTRY_MFG/function/index_x.php', data)
    .then((response)  => {
...
async function deleted() {
    ...
    await axios
    .post('../PRODUCTIONORDERENTRY_MFG/function/index_x.php', data)
    .then((response) => {
        // console.log(response.data);
        return clearForm(form);
    })
...
async function insertBack() {
    ...
    .then((response) => {
        ...
        if(result.SYSMSG != 'WARN_BOM_COUNT_ZERO') {
            // console.log(result.PROORDERNO);
            if (result.PROORDERNO != '') {
...
async function back(PROORDERNO = '') {
    ...
    .then((response) => {
        ...
        if(response.status == 200) {
            // console.log(PROORDERNO);
            if(PROORDERNO) {
                return $.redirect($('#sessionUrl').val() + '/app/'+ $('#comcd').val() +'/400/ORDERBMENTRY_MFG/index.php', { PROORDERNO: PROORDERNO });
            } else {
...
async function unsetSession() {
    ...
    data.append('systemName', 'PRODUCTIONORDERENTRY_MFG');
    await axios
    .post('../PRODUCTIONORDERENTRY_MFG/function/index_x.php', data)
    .then((response) => {
      // console.log(response.data)
...
async function clearForm(form) {
    ...
    // refresh
    window.location.href = '../PRODUCTIONORDERENTRY_MFG/';
    return false;
}
