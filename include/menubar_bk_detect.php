...
function navBar() { 
    ...
    <script src="<?=$_SESSION['APPURL'] . '/js/menu.js'; ?>" integrity="sha384-ySql/vOHmfn2pXs/+PkzgoMAdxR5ifyGa/joBTj1Zz0/dpQfyKp+7tIv51gSoZeS" crossorigin="anonymous"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('keydown', function(event) {
                ...
                if (window.event === 116 || (window.event === 116 && event.ctrlKey)) {
                    isRefresh = false;
                    window.onbeforeunload = null;
                }
            });
  
            // $(document).on('keyup change click', function(event) {
            //     // console.log(event.type);
            //     if ((event.type === 'change') || (event.key === 'Enter' || event.keyCode === 13) || (event.type === 'click')) {
            //         isRefresh = false;
                    // window.onbeforeunload = null;
            //     }
            // });
            ...
            // $('.text-control').on('click', function(event) {
