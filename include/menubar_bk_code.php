...
function navBar() { 
    ...
    <script src="<?=$_SESSION['APPURL'] . '/js/menu.js'; ?>" integrity="sha384-YSIhL9AkhdwuYYbjzBb0w2H9aMKjYQqQL3m+Dt63r3xRCw6Z0Hig7N9ldZ55+rU+" crossorigin="anonymous"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('keydown', function(event) {
                ...
                if (!pageReload) { isRefresh = false; sessionStorage.setItem('isRefresh', false);  } else { isRefresh = false; sessionStorage.setItem('isRefresh', false);}
            });
            ...
            $(window).on('mouseout keyup change click', (async function (event) {
                ...
                $(document).mouseleave(async function (e) {
