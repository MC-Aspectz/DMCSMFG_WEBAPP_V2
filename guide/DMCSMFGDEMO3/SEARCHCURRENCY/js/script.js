...
function HandleResult(result) {
  try {
    if (
      ...
      page == "SEARCHPURCHASE" ||
      page == "SEARCHGL" ||
      page == "CUSTOMERMASTER_DMCS_THA" ||
      page == "SUPPLIERMASTER_DMCS_THA"
    ) {
      window.opener.HandlePopupResult("CURRENCYCD", result);
    } else if (
      page == "ACC_PURCHSEORDERENTRY_THA" ||
      page == "ACC_RECEIVEPURCHASE_THA" ||
      page == "ACC_PURCHASEBILLSLIP" ||
      page == "ACC_PAYMENTENTRY3_THARD"
    ) {
