...
function HandleResult(result) {
  try {
    if (
      page == "ACC_OUTSTANDINGAR" ||
      page == "ACC_OUTSTANDINGAP" ||
      page == "SEARCHSALE" ||
      page == "SEARCHPURCHASE" ||
      page == "SEARCHGL"
    ) {
      ...
      page == "ACC_GENERALVO_THARD" ||
      page == "ACC_ADJUSTVO_THA" ||
      page == "ACC_ADJUSTVO_ONLY_THA" ||
      page == "ACC_PETTYCASHVO_THA" ||
      page == "SHIPREQUESTVOUCHERPRINT"
    ) {
