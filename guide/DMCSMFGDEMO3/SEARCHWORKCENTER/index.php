...
<head>
    ...
    <title><?=$_SESSION['APPNAME'].' - '.$lang['workcenterindex']; ?></title>
</head>
<body>
<main>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
               <table class="w-full border-collapse border border-slate-500" id="tb-modal" rules="cols" cellpadding="3" cellspacing="1" >
                    ...
                    <tbody>
                        <tr>
                            <td lass="text-left pl-1 border border-slate-700 text-sm"><?=$lang['WC_CODE'] ?></td>
                            <td lass="text-left pl-1 border border-slate-700 text-sm" id="WC_CODE"></td>
                        </tr>
                        <tr>
                            <td lass="text-left pl-1 border border-slate-700 text-sm"><?=$lang['WORK_CENTER_NAME'] ?></td>
                            <td lass="text-left pl-1 border border-slate-700 text-sm" id="WORK_CENTER_NAME"></td>
                        </tr>
                    </tbody>
                </table>
                <br>
