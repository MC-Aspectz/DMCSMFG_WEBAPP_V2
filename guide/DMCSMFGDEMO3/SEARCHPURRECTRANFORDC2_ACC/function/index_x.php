...
// ------------------------- CALL Langauge -------------------//
$loadApp = getSystemData('SEARCHPURRECTRANFORDC2_ACC');
if(empty($loadApp)) {
    $loadApp = $syslogic->getLoadApp('SEARCHPURRECTRANFORDC2_ACC');
    $syslogic->ProgramRundelete('SEARCHPURRECTRANFORDC2_ACC');
    setSystemData('SEARCHPURRECTRANFORDC2_ACC', $loadApp);
}
//  else {
//     $setLoadApp = $syslogic->setLoadApp('SEARCHPURRECTRANFORDC2_ACC');
// }
