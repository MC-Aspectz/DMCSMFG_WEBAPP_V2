...
<head>
    ...
    <title><?php echo $_SESSION['APPNAME'].' - '.$lang['bankindex']; ?></title>
</head>
<body>
<main>
    ...
    <form class="w-full h-screen p-2" method="POST" id="bankIndex" name="bankIndex" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
        <div class="flex mb-1">
