...
<head>
    ...
    <title><?=$_SESSION['APPNAME'].' - '.$data['DRPLANG']['APPCODE']['SEARCHPURRECTRAN_ACC3']; ?></title>
</head>
<body>
<main>
            ...
            <table id="table_result" class="w-full border-collapse border border-slate-500">
                <thead class="w-full bg-gray-100">
                    <tr class="flex w-full divide-x">
                        ...
                        <th class="w-2/12 text-center">
                            <span class="text-color text-sm font-semibold tracking-wide whitespace-nowrap"><?=checklang('PO_NO'); ?></span>
                        </th>
                        <th class="w-2/12 text-center">
                            <span class="text-color text-sm font-semibold tracking-wide whitespace-nowrap"><?=checklang('SUPPLIERCODE'); ?></span>
                        </th>
                        <th class="w-2/12 text-center">
                    ...
                    if (!empty($tdata)) { $minrow = count($tdata);
                        foreach ($tdata as $item) {  ?>
                            <tr class="flex w-full p-0 divide-x">
                                ...
                                <td class="h-6 w-2/12 pl-1 text-sm"><?=$item['PURRECORDERNO'] ?></td>
                                <td class="h-6 w-2/12 pl-1 text-sm"><?=$item['PURRECSOURCE'] ?></td>
                                <td class="h-6 w-1/12 pl-1 text-sm"><?=$item['PURRECINSPDT'] ?></td>
                                <td class="h-6 w-2/12 pl-1 text-sm"><?=$item['PURORDERNO'] ?></td>
                                <td class="h-6 w-2/12 pl-1 text-sm"><?=$item['SUPPLIERCD'] ?></td>
                ...
                <div class="modal-body">
                   <table class="w-full border-collapse border border-slate-500" id="tabel_modal" rules="cols" cellpadding="3" cellspacing="1" >
                      <thead>
                        ...
                        <tbody>
                            <tr>
                                <td class="text-left pl-1 border border-slate-700 text-sm"><?=checklang('DCVOUCHER') ?></td>
                                <td class="text-left pl-1 border border-slate-700 text-sm" id="DCVOUCHER"></td>
                            </tr>
                            <tr>
                                <td class="text-left pl-1 border border-slate-700 text-sm" style="background-color:#ffe6cc;"><?=checklang('PV_NO') ?></td>
                                <td class="text-left pl-1 border border-slate-700 text-sm" id="PV_NO" style="background-color:#ffe6cc;"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="text-left pl-1 border border-slate-700 text-sm" style="background-color:#ffe6cc;"><?=checklang('PO_NO') ?></td>
                                <td class="text-left pl-1 border border-slate-700 text-sm" id="PO_NO" style="background-color:#ffe6cc;"></td>
                            </tr>
                            <tr>
                                <td class="text-left pl-1 border border-slate-700 text-sm"><?=checklang('SUPPLIERCODE') ?></td>
                                <td class="text-left pl-1 border border-slate-700 text-sm" id="SUPPLIERCODE"></td>
                            </tr>
                            <tr>
