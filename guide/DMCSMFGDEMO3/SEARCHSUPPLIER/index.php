...
<head>
    ...
    <title><?php echo $_SESSION['APPNAME'].' - '.$lang['supplierindex']; ?></title>
</head>
<body>
<main>
    ...
    <form class="w-full h-screen p-2" method="POST" id="itemsupplier" name="itemsupplier" onkeydown="if(event.keyCode == 13) { event.preventDefault(); return false;}">
        <div class="flex mb-1">
            <div class="flex w-7/12">
                <label class="text-color block text-sm w-3/12 pr-2 pt-1"><?=$lang['suppliercd']; ?></label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="w-full border-collapse border border-slate-500" id="tb-modal" rules="cols" cellpadding="3" cellspacing="1" >
                    ...
                    <tbody>
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm"><?=$lang['suppliercd'] ?></td>
                            <td class="text-left pl-1 border border-slate-700 text-sm" id="suppliercd"></td>
                        </tr>
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm"><?=$lang['suppliername'] ?></td>
                            <td class="text-left pl-1 border border-slate-700 text-sm" id="suppliername"></td>
                        </tr>
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm"><?=$lang['address'] ?></td>
                            <td class="text-left pl-1 border border-slate-700 text-sm" id="address1"></td>
                        </tr>
                        <tr>
                            <td class="text-left pl-1 border border-slate-700 text-sm"><?=$lang['address'] ?></td>
                            <td class="text-left pl-1 border border-slate-700 text-sm" id="address2"></td>
                        </tr>
                    </tbody>
                </table>
                <br>
