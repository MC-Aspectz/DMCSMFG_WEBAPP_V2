...
$javaFunc = new SearchRecMoneyTranAcc;
$minrow = 0;
$maxrow = 10;
...
if(isset($_POST['search'])) {
	...
	// print_r($Param);
  	$tdata = $javaFunc->searchRecMoneyTran($Param);
	// echo '<pre>';
	// print_r($tdata);
	// echo '</pre>';
}
...
// ------------------------- CALL Langauge -------------------//
$loadApp = getSystemData('SEARCHRECMONEYTRAN_ACC');
if(empty($loadApp)) {
    $loadApp = $syslogic->getLoadApp('SEARCHRECMONEYTRAN_ACC');
	$syslogic->ProgramRundelete('SEARCHRECMONEYTRAN_ACC');
    setSystemData('SEARCHRECMONEYTRAN_ACC', $loadApp);
}
//  else {
//     $setLoadApp = $syslogic->setLoadApp('SEARCHRECMONEYTRAN_ACC');
// }
