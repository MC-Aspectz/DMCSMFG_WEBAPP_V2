                    ...
                    if (!empty($tdata)) {
                        ...
                        foreach ($tdata as $item) {  ?>
                            <tr class="flex w-full p-0 divide-x">
                                ...
                                <td class="h-6 w-3/12 text-sm pl-1"><?=$item['SALEORDERNO'] ?></td>
                                <td class="h-6 w-2/12 text-sm pl-1"><?=$item['CUSTOMERCD'] ?></td>
                                <td class="h-6 w-4/12 text-sm pl-1"><?=$item['CUSTOMERNAME'] ?></td>
                                <td class="h-6 w-3/12 text-sm pl-1"><?php foreach ($statusale as $i => $v) { echo $item['ORDERSTATUS'] == $i ? $v : ''; } ?></td>
                            </tr><?php 
                        }
