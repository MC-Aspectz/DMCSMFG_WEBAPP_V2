                    ...
                    if (!empty($tdata)) { $minrow = count($tdata);
                        foreach ($tdata as $item) {  ?>
                            <tr class="flex w-full p-0 divide-x">
                                <td class="h-6 w-4/12 pl-1 text-sm"><?=$item['DELIVERYCD'] ?></td>
                                <td class="h-6 w-6/12 pl-1 text-sm"><?=$item['DELIVERYNAME'] ?></td>
                                <td class="h-6 w-2/12 pl-1 text-sm"><?=$item['DELIVERYSEARCH'] ?></td>
                            </tr><?php 
                        }
                    }
